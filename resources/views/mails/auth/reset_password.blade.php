                                    ...
                                    <td align='left'>
                                        <div class="contentEditableContainer contentImageEditable">
                                            <div class="contentEditable" >
                                                <img class="banner" src="images/logo.png" width="550" alt='Afyamkononi'>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
                                    ...
                                    <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="contentEditableContainer contentTextEditable">
                                                        <div class="contentEditable" >
                                                            <h2 style='font-size:32px; line-height:36px;text-align:center;font-weight:bold;'>{{$subject}}</h2>
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="contentEditableContainer contentTextEditable">
                                                        <div class="contentEditable" >
                                                            <p><strong>{{$user->first_name}},</strong><br></p>
                                                            <p style="padding-left: 10px!important;color: #444!important;">
                                                                <br><br>
                                                    ...
                                                    <div class="contentEditableContainer contentTextEditable">
                                                        <div class="contentEditable" >
                                                            <p style='text-align:center'>
                                                                <a target='_blank' href="{{url('/reset/password/'.$user->usertoken->last()->token)}}" class='link1' style='color:#ffffff;'>RESET PASSWORD</a>
                                                            </p>
                                                        </div>
                                                    </div>
                                                </td>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="contentEditableContainer contentTextEditable">
                                                        <div class="contentEditable" >
                                                            <p style="color: #444;">Please let us know if we can answer any questions. We look forward to making your life healthier, longer, and happier :)</p><br>
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
                                                    ...
                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                        ...
                                                        <tr>
                                                            <td align='center'>
                                                                <div class="contentEditableContainer contentTextEditable">
                                                                    <div class="contentEditable" >
                                                                        <p style='font-size:13px;color:#999999;font-weight:bold;'>Sent to {{$user->email}} by {{$app->name}} | {{$app->address}} | {{$app->mobile}}</p>
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <tr>
                                                            <td align='center' style='font-size:13px;color:#999999;'>
                                                                <div class="contentEditableContainer contentTextEditable">
                                                                    <div class="contentEditable" >
                                                                        <p><a target='_blank' href="{{url('/')}}" style='font-size:13px;color:#999999;text-decoration:none;line-height:19px;'>Home</a> | <a target='_blank' href="{{url('/')}}" style='font-size:13px;color:#999999;text-decoration:none;line-height:19px;'> Open in browser </a> | <a target='_blank' href="{{url('/')}}" style='font-size:13px;color:#999999;text-decoration:none;line-height:19px;'>Unsubscribe</a></p>
                                                                    </div>
                                                                </div>
