                            ...
                            <tbody><tr>
                                <td width="100%" class="image191" align="center">
                                    ...
                                    <table width="191" border="0" cellpadding="0" cellspacing="0" align="left" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" class="full">
                                        <tbody><tr>
                                            <td width="100%" class="fullCenter">
                                                <a href="#" style="text-decoration: none;"><img src="http://envisagemobile.com/images/afyamkononi.png" width="191" height="auto" alt="" border="0" class="hover"></a>
                                            </td>
                                        </tr>
                                        </tbody></table>
                                    ...
                                    <table width="350" border="0" cellpadding="0" cellspacing="0" align="right" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" class="fullCenter">
                                        <tbody><tr>
                                            <td valign="middle" width="100%" style="text-align: left; font-family: Helvetica, Arial, sans-serif, 'Open Sans'; font-size: 19px; color: #444444; line-height: 32px; font-weight: 700;" class="fullCenter">
                                                Hi {{$user->first_name}}!
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td width="100%" class="buttonScale" align="left">
                                                ...
                                                <table border="0" cellpadding="0" cellspacing="0" align="left" class="buttonScale">
                                                    <tbody><tr>
                                                        <td width="auto" align="center" height="37" bgcolor="#019cdc" style="padding-left: 22px; padding-right: 22px; font-weight: 400; font-family: Helvetica, Arial, sans-serif, 'Open Sans'; color: #ffffff;">
                                                            <a href="{{url('/reset/password/'.$user->usertoken->last()->token)}}" style="color: #ffffff; font-size: 14px; text-decoration: none; text-transform: uppercase; line-height: 34px; width: 100%;">RESET PASSWORD</a>
                                                        </td>
                                                    </tr>
                                                    </tbody></table>
...
<table width="100%" style="background-color: #fff;" border="0" cellpadding="0" cellspacing="0" align="center" class="full">
    <tbody>
    <tr>
        <td align="center" width="100%" valign="top" bgcolor="#344b61">

            <!-- Wrapper -->
            <table width="100%" border="0" style="background-color: #fff;" cellpadding="0" cellspacing="0" align="center" class="mobile">
                <tbody><tr>
                    <td align="center">
                                    ...
                                    <table width="260" border="0" cellpadding="0" cellspacing="0" align="left" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" class="full">
                                        ...
                                        <tr>
                                            <td valign="middle" width="100%" style="text-align: left; font-family: Helvetica, Arial, sans-serif, 'Open Sans'; font-size: 14px; color: #ffffff; line-height: 22px; font-weight: 400;" class="fullCenter">
                                                <a href="#" style="text-decoration: none; color: #ffffff;">About us</a><br>
                                                <a href="#" style="text-decoration: none; color: #ffffff;">Blog</a><br>
                                                <a href="#" style="text-decoration: none; color: #ffffff;">Terms of Use</a><br>
                                                <a href="#" style="text-decoration: none; color: #ffffff;">Code of Contact</a><br>
                                                <a href="#" style="text-decoration: none; color: #ffffff;">Corporate Careers</a><br>
                                            </td>
                                        </tr>
                                        </tbody>
                                    </table>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" align="center" class="full">
    <tbody><tr>
        <td align="center" width="100%" valign="top" bgcolor="#344b61">
            <!-- Wrapper -->
            <table width="100%" style="background-color: #15172d;" border="0" cellpadding="0" cellspacing="0" align="center" class="mobile">
                <tbody><tr>
                    <td align="center">
                        <!-- Wrapper -->
                        <table width="600" border="0" cellpadding="0" cellspacing="0" align="center" class="full">
                            <tbody>
                            <tr>
                                <td width="100%" align="center" style="background-color: #15172d;">

                                    <!-- Text Left -->
                                    <table width="100%" border="0" cellpadding="0" cellspacing="0" align="left" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;background-color: #15172d;" class="full">
                                        <tbody>
                                        <tr>
                                            <td width="100%">
                                                <table border="0" cellpadding="0" cellspacing="0" align="center" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" class="fullCenter">
                                                    <tbody><tr>
                                                        <td height="60" style="text-align: center; font-family: Helvetica, Arial, sans-serif, 'Open Sans'; font-size: 14px; color: #aebecd; line-height: 21px; vertical-align: middle; word-break:break-all; font-weight: 400;">
                                                            <a href="{{url('/')}}" style="text-decoration: none; color: #fff;">Copyright © 2018 {{config("APP_NAME")}} . All Rights Reserved</a>
                                                        </td>
                                                    </tr>
                                                    </tbody></table>
                                            </td>
