...
<html lang="en">
	<head>
        ...
        <!-- vector map CSS -->
        <link rel="stylesheet" href="{{URL::asset('vendors/bower_components/jasny-bootstrap/dist/css/jasny-bootstrap.min.css')}}">
		<!-- Custom CSS -->
			...
			<header class="sp-header">
				<div class="sp-logo-wrap pull-left">
					<a href="index.html">
						...
						<span class="brand-text">e-Retailer</span>
					</a>
				</div>
							...
							<div class="auth-form  ml-auto mr-auto no-float">
								<div class="row">
									<div class="col-sm-12 col-xs-12">
										<div class="mb-30 logins">
											<h3 class="text-center txt-dark mb-10">Sign in to <span>e-Retailer</span></h3>
