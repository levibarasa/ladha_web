            ...
            <div class="content-wrapper">
                ...
                <div class="row page-tilte align-items-center">
                  <div class="col-md-auto">
                    ...
                    <p class="text-muted m-0 desc">Order details</p>
                  </div> 
                  <div class="col controls-wrapper mt-3 mt-md-0 d-none d-md-block ">
                    <div class="controls d-flex justify-content-center justify-content-md-end">
                        ...
                        <router-link :to="ECOMMERCE.ORDERS" class="btn btn-secondary py-1 px-2" title="Back" ><span class="material-icons align-text-bottom">arrow_back</span></router-link>
                        <!-- <button type="button" class="btn btn-secondary py-1 px-2"><span class="material-icons align-text-bottom">arrow_back</span></button> -->
                ...
                <div class="content">
                    <!-- <products-table v-if="dataReady" :BASE_URL="BASE_URL" :PRODUCT_DETAIL="PRODUCT_DETAIL" :inventories="inventories"/>
...
export default {
    name: "Show",
    components: {SideBar,TopBar,ProductsTable,DataLoading},
    data(){
        return {
            inventories: [],
            filters: {},
