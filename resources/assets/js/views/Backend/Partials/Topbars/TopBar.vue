<template>
    <header class="header sticky-top">
        <nav class="navbar navbar-light bg-white px-sm-4 ">
            ...
            <ul class="navbar-nav flex-row ml-auto">
                ...
                <li class="nav-item ml-sm-3 user-logedin dropdown">
                    <a href="#" id="userLogedinDropdown" data-toggle="dropdown" class="nav-link weight-400 dropdown-toggle"><img src="/assets/icons/dashboard/staff1.png" class="mr-2 rounded" width="28">{{email}}</a>
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="userLogedinDropdown">
                    <a class="dropdown-item" href="#">My Account</a>
                    <a class="dropdown-item" href="#">Account Settings</a>
                    <a class="dropdown-item" target="_blank">Help & Support</a>
        ...
        <app-modal :modal_id="'switchApp'"></app-modal>
    </header>
</template>
<script>
import AppModal from "../Modals/Menus/AppModal";
...
export default {
    ...
    methods: {
        logout(){
            auth.remove();
            this.$router.push(LP_LINKS.HOME);
        }
    }
}
</script>